...
<body>
    <div id="header">
            ...
            <div class="container py-1">
                ...
                <div id="navigationBar" class="justify-content-center collapse navbar-collapse col">
                    <div class="navbar-nav nav-fill">
                        <a href="#tabPayement" data-bs-toggle="collapse" aria-controls="tabPayement" aria-expanded="false" class="nav-link dropdown-toggle">Payement</a>
        ...
        <div class="collapse secondaryBar interdependantBars" id="tabPayement">
            <div class="container py-4">
                <div class="row">
                    <div class="col text-center my-2">
                        <a href="modele_accueilUser.php?folder=payement&page=listPayement" class="personnalisedLink">Liste des payements pour les cueilleurs</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container" id="encadrFooter">
